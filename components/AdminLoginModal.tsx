...
import { CogIcon, UserCircleIcon, LockClosedIcon, CheckCircleIcon, XCircleIcon } from './Icons';
    ...
    >
      <div className="bg-white dark:bg-neutral-800 p-6 md:p-8 rounded-xl shadow-2xl w-full max-w-sm transform transition-all duration-300 ease-in-out scale-100">
        <div className="flex justify-between items-center mb-6">
          <h2 id="admin-login-title" className="text-2xl font-semibold text-primary flex items-center">
            <CogIcon className="w-6 h-6 mr-2" /> {t('adminLoginTitle')}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="adminUsername" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">
              {t('usernameLabel')}
            </label>
          ...
          <div>
            <label htmlFor="adminPassword" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">
              {t('passwordLabel')}
            </label>
             <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
